! function() {
    ...
    var x = Object.freeze({
        ...
        pl: function(s, n) {
            return d[1 & n ? 4 < s % 10 || s % 10 < 2 || 1 == ~~(s / 10) % 10 ? n : ++n / 2 + 13 : n]
        },
        pt_BR: function(s, n) {
            return [
        ...
        ru: function(s, n) {
            switch (n) {
                ...
                case 1:
                    return [l(s) + " назад", "через " + l(s)];
                case 2:
                case 3:
                    return [c(s) + " назад", "через " + c(s)];
                case 4:
                case 5:
                    return [h(s) + " назад", "через " + h(s)];
                case 6:
                    return ["вчера", "завтра"];
                case 7:
                    return [g(s) + " назад", "через " + g(s)];
                case 8:
                case 9:
                    return [p(s) + " назад", "через " + p(s)];
                case 10:
                case 11:
                    return [f(s) + " назад", "через " + f(s)];
                case 12:
                case 13:
                    return [b(s) + " назад", "через " + b(s)];
                default:
                    return ["", ""]
            }
        },
        ...
        sr: function(s, n) {
            switch (n) {
                ...
                case 1:
                    return ["пре " + k(s), "за " + k(s)];
                case 2:
                case 3:
                    return ["пре " + y(s), "за " + y(s)];
                case 4:
                case 5:
                    return ["пре " + v(s), "за " + v(s)];
                case 6:
                case 7:
                    return ["пре " + j(s), "за " + j(s)];
                case 8:
                case 9:
                    return ["пре " + z(s), "за " + z(s)];
                case 10:
                case 11:
                    return ["пре " + q(s), "за " + q(s)];
                case 12:
                case 13:
                    return ["пре " + w(s), "за " + w(s)];
                default:
                    return ["", ""]
            }
        },
        ...
        uk: function(s, n) {
            switch (n) {
                ...
                case 1:
                    return [_(s) + " тому", "через " + _(s)];
                case 2:
                case 3:
                    return [S(s) + " тому", "через " + S(s)];
                case 4:
                case 5:
                    return [W(s) + " тому", "через " + W(s)];
                case 6:
                case 7:
                    return [N(s) + " тому", "через " + N(s)];
                case 8:
                case 9:
                    return [T(s) + " тому", "через " + T(s)];
                case 10:
                case 11:
                    return [J(s) + " тому", "через " + J(s)];
                case 12:
                case 13:
